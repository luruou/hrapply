                    ...
                    <div class="tabContents">
                        ...
                        <asp:MultiView ID="MVall" runat="server" ActiveViewIndex="0"
                            ...
                            <asp:View ID="ViewThesisScore" runat="server">
                                <font color="red">
                                    <asp:Label runat="server" Text="(合併)個人研究重點與成果&論文積分表：" ID="lb_ReasearchResult" /></font>
                                                    ...
                                                    <asp:TableRow ID="TableR2" runat="server">
                                                        ...
                                                        <asp:TableCell ID="TableC4" runat="server" class="style4">
                                                            ...
                                                            <asp:SqlDataSource ID="DSRR" runat="server"
                                                                ConnectionString="<%$ ConnectionStrings:tmuConnectionString %>"
                                                                SelectCommand="SELECT [RRNo], [RRNameAbbr], [RRName] FROM [CResearchResult] where RRNo not in ('5')"></asp:SqlDataSource>
                                                            <br />
                                                            (研究成果分類)
                                                        </asp:TableCell>
                                                    </asp:TableRow>
                                ...
                                <div class="modal fade" id="modalThesisCoop" tabindex="-1" role="dialog" aria-labelledby="modalThesisCoop" aria-hidden="true">
                                    <div class="modal-dialog modal-lg" role="document">
                                            ...
                                            <div class="modal-body">
                                                <asp:Table ID="TBThesisCoopInsert" runat="server" class="table table-bordered table-condensed" Width="100%">
                                                    ...
                                                    <asp:TableRow ID="TableRow14" runat="server">
                                                        ...
                                                        <asp:TableCell ID="TableCell6" runat="server" class="style4">
                                        ...
                                        貢獻比例(C)：
                                                        ...
                                                        <asp:TableCell ID="TableCell25" runat="server">
                                                            ...
                                                            <div class="input-group mb-2">
                                                                ...
                                                                <asp:TextBox ID="txtContribute" runat="server" Text="" class="form-control" />
                                                    ...
                                                    <asp:TableRow ID="TableRow18" runat="server">
                                                        ...
                                                        <asp:TableCell ID="TableCell27" runat="server" class="style4">
                                                           <span></span>
                                                        </asp:TableCell>
                                                    </asp:TableRow>
                                        ...
                                        上傳檔案：
                                                            ...
                                                            <asp:TextBox ID="TextBox9" runat="server" Width="80%" class="form-control"></asp:TextBox>
                                                            <br />
                                                            <asp:CheckBox ID="CheckBox2" runat="server" title="取消勾可刪除" />
                                                            <asp:TextBox ID="TextBox10" runat="server"
                                                                ReadOnly="true" Text="" Visible="false"></asp:TextBox>
                                                            <asp:HyperLink ID="HyperLink2" runat="server" Visible="false"></asp:HyperLink>
                                            ...
                                            <div class="modal-footer">
                                                 <asp:Button ID="ThesisCoopCreate" runat="server" class="btn btn-primary" OnClick="ThesisCoopCreate_Click" Text="新增" />
                                                 <asp:Button ID="ThesisCoopUpdate" runat="server" class="btn btn-primary" OnClick="ThesisCoopUpdate_Click" Text="更新"  />
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td>
                                            <span style="color: black">1.依本校「教師著作升等研究部分最低標準施行要點」規定，以本校最新版之論文歸類計分(研究表現指數計分表)方式行之。SCIE、SSCI、EI之期刊論文資料，可就近至各大學圖書館、國科會科技政策研究與資訊中心等查閱或上網檢索。目前SCIE、SSCI、EI期刊以<font color='red'>2020</font>版本為準。<br />
                                                2.五年內<font color="red">(2017.2.1至2022.4.30)</font>且<font color="red">符合前職等教師資格</font>之論文計分，最高採計<font
                                                    color="red">15</font>篇。<br />
                                                <font color="red">3.</font>若有文章2016年底前接受發表於本校所發行之國際期刊(JECM)者，可提一篇其計分方式以學術論文刊登雜誌加權分數(J)=4分計算。<br />
                                                4.填寫說明：<br />
                                                ...
                                                <font color="red">★</font>4.刊登雜誌分類排名<font color="red">以最新版本之SCIE及SSCI資料為準。</font><br />
                                            ...
                                            <asp:GridView ID="GVThesisScore" runat="server" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="No" ItemStyle-Width="100">
                                                        <HeaderStyle CssClass="hiddencol" />
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblSnNo" runat="server" Text='<%#Bind("SnNo")%>'></asp:Label>
                                                        </ItemTemplate>
                                                        <ItemStyle CssClass="hiddencol" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="No" ItemStyle-Width="100">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="IsRepresentative" runat="server"
                                                                Text='<%#Bind("IsRepresentative")%>'></asp:TextBox>
                                                        </ItemTemplate>
                                                        <ItemStyle CssClass="hiddencol" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="No" ItemStyle-Width="100">
                                                    ...
                                                    <asp:TemplateField HeaderText="下載">
                                                        <ItemTemplate>
                                                            <asp:HyperLink ID="HyperLinkThesis" CssClass="far fa-save" runat="server"></asp:HyperLink>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField>
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField ShowHeader="False">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="LinkThesisDelete" runat="server" class="btn btn-danger" Style="color: white"
                                                                ...
                                                                OnClientClick="return confirm('確認要是否要刪除？');" Text="刪除"></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            </asp:GridView>
                                            ...
                                            <asp:GridView ID="GVThesisScoreCoAuthor" runat="server"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="檢附資料下載" HeaderStyle-Width="8%">
                                                        <ItemTemplate>
                                                            <asp:HyperLink ID="HyperLinkThesisJournalRef" CssClass="far fa-save" runat="server"></asp:HyperLink>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="合著人證明" HeaderStyle-Width="8%">
                                                        <ItemTemplate>
                                                            <asp:HyperLink ID="HyperLinkThesisCo" CssClass="far fa-save" runat="server">下載</asp:HyperLink>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="ThesisCoAuthorUploadName">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:Label ID="ThesisCoAuthorUploadName" runat="server"
                                                                Text='<%#Bind("ThesisCoAuthorUploadName")%>'></asp:Label>
                                                        </ItemTemplate>
                                                        <ItemStyle CssClass="hiddencol" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="ThesisJournalRefUploadName">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:Label ID="ThesisJournalRefUploadName" runat="server"
                                                                Text='<%#Bind("ThesisJournalRefUploadName")%>'></asp:Label>
                                                        </ItemTemplate>
                                                        <ItemStyle CssClass="hiddencol" />
                                                    </asp:TemplateField>
                                                </Columns>
                                ...
                                <table style="font-size: 12pt; width: 100%;" class="table table-bordered table-condensed">
                                    <tr>
                                        <td style="width: 15%; text-align: right">(1) 論文總積分： </td>
                                        <td>
                                            <asp:Label ID="AppPThesisAccuScore" runat="server" Text=""></asp:Label><br />
                                            總計<asp:Label ID="PaperCount" runat="server" ForeColor="#FF3300"></asp:Label>篇，超過<asp:Label ID="PaperOver" runat="server" ForeColor="#FF3300"></asp:Label>篇<br />
                                            (最高採計15篇, 各項研究成果分數之總和)</td>
                                    </tr>
                                    <tr>
                                        <td style="text-align: right">折抵論文積分：</td>
                                        <td>
                                            <asp:CheckBox ID="RPIDiscountNo" runat="server" Text=""></asp:CheckBox>&nbsp;無下列資料請打勾<br />
                                            獲獎折抵(請檢附PDF文件，無折抵者免附)<br />
                                            1.<asp:CheckBox ID="RPIDiscountScore1" runat="server" title="師鐸獎：60分" />&nbsp;師鐸獎：60分
                                        &nbsp;&nbsp;&nbsp;<asp:CheckBox ID="RPIDiscountScore1UploadCB" runat="server" title="取消勾可刪除" />
                                            <asp:TextBox ID="RPIDiscountScore1UploadFUName" runat="server" ReadOnly="true"
                                                Style="display: none;" Text="" MaxLength="100"></asp:TextBox><asp:HyperLink ID="RPIDiscountScore1HyperLink" runat="server" Visible="false"></asp:HyperLink><asp:FileUpload ID="RPIDiscountScore1UploadFU" runat="server" /><br />
                                            <br />
                                            2.教師優良教師：
                                            ...
                                            </asp:DropDownList>&nbsp;&nbsp;&nbsp;<asp:CheckBox ID="RPIDiscountScore2UploadCB" runat="server" title="取消勾可刪除" />
                                            <asp:TextBox ID="RPIDiscountScore2UploadFUName" runat="server" ReadOnly="true"
                                                Style="display: none;" Text="" MaxLength="100"></asp:TextBox><asp:HyperLink ID="RPIDiscountScore2HyperLink" runat="server" Visible="false"></asp:HyperLink><asp:FileUpload ID="RPIDiscountScore2UploadFU" runat="server" /><br />
                                            <br />
                                            3.優良導師：
                                            &nbsp;&nbsp;&nbsp;<asp:DropDownList ID="RPIDiscountScore3" runat="server" class="form-control">
                                                ...
                                                <asp:ListItem Value="60">校級：60分</asp:ListItem>
                                                <asp:ListItem Value="30">院級：30分</asp:ListItem>
                                            </asp:DropDownList>&nbsp;&nbsp;&nbsp;<asp:CheckBox ID="RPIDiscountScore3UploadCB" runat="server" title="取消勾可刪除" />
                                            <asp:TextBox ID="RPIDiscountScore3UploadFUName" runat="server" ReadOnly="true"
                                                Style="display: none;" Text="" MaxLength="100"></asp:TextBox><asp:HyperLink ID="RPIDiscountScore3HyperLink" runat="server" Visible="false"></asp:HyperLink><asp:FileUpload ID="RPIDiscountScore3UploadFU" runat="server" /><br />
                                            <br />
                                            4.執行人體試驗：
                                            ...
                                            5.執行產學合作計畫：<br/>
                                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalThesisCoop">新增</button>


                                            <asp:Label ID="Label16" runat="server"><font color="red">(檔名請勿使用／, ？, ＊, ［, ］, ' , &, " , ?等符號)</font></asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td style="text-align: right">(2)折抵總積分：</td>
                                        <td>
                                            <asp:Label ID="RPIDiscountTotal" runat="server" Text=""></asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td style="text-align: right">總積分：</td>
                                        <td>(1)論文總積分：<asp:Label ID="AppPThesisAccuScore1" runat="server" Text=""></asp:Label>&nbsp;+&nbsp;(2)折抵論文積分：<asp:Label ID="RPIDiscountTotal1" runat="server" Text=""></asp:Label>&nbsp;=&nbsp;<asp:Label ID="AppRPITotalScore" runat="server" Text=""></asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td id="TableC1" runat="server" style="text-align: right">研究年資：</td>
                                        <td id="TableC2" runat="server">
                                    ...
                                    <tr style="display: none">
                                        ...
                                        <td style="text-align: right">已選RPI積分小計：</td>
                                        <td><font color="green">
                                            <asp:Label ID="ComputeRPI" runat="server" Text="" Width="59px"></asp:Label></font><br />
                                            (自動計數值供使用者參考)<br />
                                            <asp:TextBox ID="AppRPI" runat="server" Text="" class="form-control"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td style="text-align: right">論文折抵暨總分：</td>
                                        <td>
                                            <asp:Button ID="SaveAppRPI" runat="server" OnClick="AppRPIDiscountSave_Click" PostBack="True" Text="計算儲存" class="btn btn-primary" /><br />
                                            <font color="red">(請按此儲存折抵暨總分)</font> </td>
                                    </tr>
                                </table>
                            </asp:View>
                            <asp:View ID="ViewDegreeThesis" runat="server">
                                <asp:Table runat="server" ID="AboutDegree" Width="100%" border="1" CellSpacing="0" CellPadding="0" bgcolor="lightgoldenrodyellow" class="table table-bordered table-condensed">
                                    ...
                                    國外學歷：
                                        ...
                                        <asp:TextBox ID="AppDFgnGradeUploadFUName" runat="server" ReadOnly="true"
                                            ...
                                            <asp:FileUpload ID="AppDFgnSelectCourseUploadFU" runat="server" /><br />
                                            （修業期限：累計在當地學校修業時間： 碩士學位須滿8個月；博士學位須滿16個月；連續修讀碩、博士學位須滿24個月）。<br />
                                ...
                                <br />
                                <div>
                                    ※摘錄「教育部辦理專科以上學校教師著作審查委員遴選原則」：<br />
                                    (一)審查委員具有下列情形之一者，應迴避審查。<br />
                                    1.送審人之研究指導教授。<br />
                                    2.送審人代表著作之合著人或共同研究人。<br />
                                    3.與送審人有密切合作關係者。<br />
                                    4.與送審者有親屬關係或有特殊事宜者。<br />
                                    (二)審查委員之遴選為顧及公平性與平衡性，宜盡量兼顧下列原則：<br />
                                    1.同一案件之審查委員儘可能避免均由同一學校之教授擔任。<br />
                                    2.送審人畢業學校之教授盡可能迴避，（尤其是畢業時間十年以內，且為同一系所者）。<br />
                                    3.與送審人為同校系且同時期畢業者盡可能迴避審查。<br />
                                    4.曾與送審者共同參與相關研究者，盡可能迴避審查。<br />
                                    <br />
                                    <font color="red">※本表如未填寫視同無迴避名單提供</font><br />
                                    <div style="float: right;">
                                ...
                                <br />
                                <hr />
                                <div class="modal fade" id="modalAvoidList">
                                    <div class="modal-dialog modal-lg">
                                        <!-- Modal content-->
                                        <div class="modal-content">
                                            <div class="modal-body">
                                                ...
                                                <table width="100%" class="table table-bordered table-condensed">
                                                    <tr>
                                                        <td style="text-align: right;">身分別：<asp:TextBox ID="TBIntThesisOralSn" Visible="false" runat="server"></asp:TextBox></td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="ThesisOralName" runat="server" class="form-control"></asp:TextBox></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="text-align: right">職稱：</td>
                                                        <td>
                                                            <asp:TextBox ID="ThesisOralTitle" runat="server" class="form-control"></asp:TextBox></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="text-align: right">服務單位：</td>
                                                        <td>
                                                            <asp:TextBox ID="ThesisOralUnit" runat="server" class="form-control"></asp:TextBox></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="text-align: right">其他備註：</td>
                                                        <td>
                                                            <asp:TextBox ID="ThesisOralOther" runat="server" class="form-control"></asp:TextBox><br />
                                                            <asp:Label ID="AvoidReason" runat="server" Visible="false" Text="(迴避理由)" ForeColor="Red" /></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2" style="text-align: center">
                                        ...
                                        <td style="text-align: left">
                                            <asp:GridView ID="GVThesisOral" runat="server" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" CssClass="table table-bordered table-condensed" DataKeyNames="ThesisOralSn" HeaderStyle-BackColor="#0080ff" HeaderStyle-ForeColor="White" OnRowDataBound="GVThesisOral_RowDataBound" EnableModelValidation="True" ForeColor="Black" GridLines="Horizontal">
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="ThesisOralName" HeaderText="姓名" HeaderStyle-Width="10%"
