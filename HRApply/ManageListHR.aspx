<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" EnableEventValidation="false" EnableSessionState="true" AutoEventWireup="true" CodeFile="ManageListHR.aspx.cs" Inherits="ApplyPromote._ManageListHR" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div>
        ...
        <asp:Label ID="LoginName" runat="server" Visible="false"></asp:Label>
            <asp:CheckBox ID="CBNowAudit" runat="server" OnCheckedChanged="approveUnt_SelectedIndexChanged" AutoPostBack="true" />
            ...
            <div style="font-size: 16px; background-color: #f0f0f0; border-radius: 10px;">
                <div style="padding: 10px">
                    ...
                    <div class="row" id="TableRow0" runat="Server">
                        ...
                        <div class="col-lg-10">
                            <asp:DropDownList ID="SelYear" runat="server" class="form-control"  Width="15%">
