...
namespace ApplyPromote
{
    public partial class Apply : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            isTWZH = Thread.CurrentThread.CurrentCulture.LCID == 1028;
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                ApplyWayNo.DataValueField = "WayNo";
                ApplyWayNo.DataTextField = isTWZH ? "WayName" : "WayNameE";
                ApplyWayNo.DataSource = crudObject.GetAllAuditWayName();
                ApplyWayNo.DataBind();

                ApplyAttributeNo.DataValueField = "AttributeNo";
                ApplyAttributeNo.DataTextField = isTWZH ? "AttributeName" : "AttributeNameE";
                ApplyAttributeNo.DataSource = crudObject.GetAuditAttributeByKindNo(1);
                ApplyAttributeNo.DataBind();


                ddlApplicationType.DataValueField = "AttributeNo";
                ddlApplicationType.DataTextField = isTWZH ? "AttributeName" : "AttributeNameE";
                ddlApplicationType.DataSource = crudObject.GetAuditAttributeByKindNo(1);
        ...
        protected void ApplyKindNo_SelectedIndexChanged(object sender, EventArgs e)
        {
            ApplyAttributeNo.DataValueField = "AttributeNo";
            ApplyAttributeNo.DataTextField = isTWZH ? "AttributeName" : "AttributeNameE";
            ApplyAttributeNo.DataSource = crudObject.GetAuditAttributeByKindNo(Convert.ToInt32(ApplyKindNo.SelectedValue));
            ApplyAttributeNo.DataBind();

            ApplyWayNo.Visible = ApplyKindNo.SelectedValue.Equals("2");
        }
        ...
        protected void btnLogout_Click(object sender, EventArgs e)
        {
            ...
            Session.Abandon();
            Response.Redirect("http://www.google.com/accounts/Logout?continue=https://appengine.google.com/_ah/logout?continue=https://hr2sys.tmu.edu.tw/HrApply/Default.aspx");
        }
        ...
        protected void UnTMUSend_Click(object sender, EventArgs e)
        {
            ...
            if (ApplyerEmail.Text != "" && ApplyerPwd.Text != "")
            {
                ...
                parameters = "ApplyerID=" + DES.Encrypt(applyID) + "&ApplyKindNo=" + DropDownList1.SelectedValue + "&ApplyWayNo=1&ApplyAttributeNo=" + ddlApplicationType.SelectedValue;
        ...
        protected void lkb_TMU_Click(object sender, EventArgs e)
        {
            ...
            if (txt_identity.Text == "")
                Response.Redirect("http://glbsys.tmu.edu.tw/OAuth/OAuthCheck.aspx?domainname=hr2sys.tmu.edu.tw&systemname=HrApply&callbackurl=default.aspx&sslport=true");
